            ...
            <div className="flex justify-between">
                ...
                <div className="pl-28">
                    <div className="rounded-lg bg-white w-96 text-center p-1 h-max px-4">
                        ...
                        <InputBox label="Contact Details" type="email" placeholder="Vendor Contact Details" onChange={(e) => {
                        ...
                        <InputBox label="Password" type="password" placeholder="Vendor Password" onChange={(e) => {
